...
console.log('Car ' + inventory[lastCar].id + ' is a ' + inventory[lastCar].car_model  + ' ' + inventory[lastCar].car_make);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = [];
var stringModel = "Models: ";
...
for (let i = 0; i < carYears.length; i++) {
    stringYears += carYears[i];
    if (i != carYears.length-1) {
        stringYears += ', ';
    }
}
